...
jQuery.fn.dataTableExt.oSort['datetime-fr-asc']  = function(a,b) {
  var datetimea = a.split(' à ');
  var datetimeb = b.split(' à ');
  var datea = datetimea[0].split('/');
  var dateb = datetimeb[0].split('/');
  var timea = datetimea[1] ? datetimea[1].split('h') : '';
  var timeb = datetimeb[1] ? datetimeb[1].split('h') : '';

  var x = (datea[2] + datea[1] + datea[0] + timea[0] + timea[1]) * 1;
  var y = (dateb[2] + dateb[1] + dateb[0] + timeb[0] + timeb[1]) * 1;

  return ((x < y) ? -1 : ((x > y) ?  1 : 0));
};
jQuery.fn.dataTableExt.oSort['datetime-fr-desc'] = function(a,b) {
  var datetimea = a.split(' à ');
  var datetimeb = b.split(' à ');
  var datea = datetimea[0].split('/');
  var dateb = datetimeb[0].split('/');
...
jQuery.fn.dataTableExt.oSort['date-fr-asc']  = function(a,b) {
  var datea = a.split('/');
  var dateb = b.split('/');
...
jQuery.fn.dataTableExt.oSort['date-fr-desc'] = function(a,b) {
  var datea = a.split('/');
  var dateb = b.split('/');
